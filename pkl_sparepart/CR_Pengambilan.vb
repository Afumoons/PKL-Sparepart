...
Public Class CR_Pengambilan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pkl_sparepart.CR_Pengambilan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Kode_Pengambilan() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCR_Pengambilan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Pengambilan = New CR_Pengambilan()
        rpt.Site = Me.Site
        Return rpt
    End Function
